 ...
 * @author Usuario
 */
public class eliminarL extends javax.swing.JFrame {

    /**
     * Creates new form eliminarL
     */
    public eliminarL() {
        initComponents();
    ...
    private void enviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarActionPerformed
        try {
            int val = JOptionPane.showConfirmDialog(null, "si");
            if (val == 0) {
                ...
                if(id >0)
                {
                    ...
                    panta.eliminarMovimiento(id);
                    panta.actualizarMovimientos();
                    if(panta.tipo(id)==1)
                    {
                        panta.actualizarCaja(panta.caja()-panta.montoCaja(id));
                    }else {panta.actualizarCaja(panta.caja()+panta.montoCaja(id));}
        ...
        }finally{PantallaPrincipalUsuario panta = new PantallaPrincipalUsuario();
            panta.setVisible(true);}
